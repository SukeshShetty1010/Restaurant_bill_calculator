...
print("*"*5 + "#"*5 + "Vatsal cosmetics" + "#"*5 + "*"*5)  # Cafe Name
name = 0
address = 0
phone = 0
email = 0
...
menu = pd.read_csv(r"C:\Users\sukes\OneDrive\Desktop\assignment\cosmetics_list_csv.csv", encoding='cp1252') # this line will store the data in the menu variable from the csv file as a dataframe
...
food_suggestion_dataframe = pd.read_csv(r"C:\Users\sukes\OneDrive\Desktop\assignment\cosmetics_suggestion.csv", encoding='cp1252') # this line will read the data from csv and save it in dataframe
        ...
        while loop_menu == 0:
            ...
            if task_of_customer == 2:
                if name != 0 and address != 0 and phone != 0:
                    ...
                    no_of_orders = int(input("Enter the no of cosmetics you want to order :- "))# here the user will enter the no of food he wants to order
                    print()
                    i = 0
                    ...
                    while i < no_of_orders :
                        food_ordered_everytime = input("Enter the name of the cosmetics you want :- ")# here the user will enter the name of the food he want to order
                        print()
                        no_of_dishes = int(input("Enter the no of cosmetics you want to order :- "))# here the user will enter the no of plates of the dish he needs
                        print()
                    ...
                    print()
                    food_suggestion_dataframe = pd.read_csv(r"C:\Users\sukes\OneDrive\Desktop\assignment\cosmetics_suggestion.csv", encoding='cp1252') # this line will brinh the food suggestion from the csv in dataframe
                    i = 0
                    ...
                    while i < no_of_orders:
                        for keys,values in food_ordered_total.items():#this line will display the food ordered by the customer
                            ...
                            if suggestion_want_not == 'y':
                                no_of_plates = int(input("enter the no of cosmetics you would like :- ")) # if user wants to enter the food in menu the program will ask no of plates of the dishes he need
                                print()
                                print("The cosmetics has been added to the suggestion")
                                print()
                    ...
                    print("Please first enter your details then order the cosmetics ")
                    print()
    ...
    if owner_or_customer == "o":
        ...
        while loop_entry == 1 : # loop to make user name and password come sgain and again
            ...
            if username == "owner" and password == "12345": #this line will check weather the user has entered correct username and password
                print("Welcome the owner of vatsal cosmetics")
                print()
                loop_entry = 0
                print("What would you like to do :- ")
                print()
                print("1. Change the price of cosmetics")
                print()
                print("2.  Add cosmetics to the list")
                print()
                print("3. Delete cosmetics from the list")
                print()
                ...
                if task_of_owner == 1:
                    ...
                    while loop_price_change == 1: 
                        for keys,values in food_list.items():# this line will store the key and values in the food list
                            print(keys,"",":","", values) #This line will print the key value paor of the dataframe
                            print()
                        food_for_price_change = input("Enter the name of the cosmetics whose price you want to change :- ") # here the user will enter the name of the food whose price to be changed
                        if food_for_price_change in food_list: # this will check weather the food is in the food list
                            print("The current price of the cosmetics is :- ",food_list[food_for_price_change]) # this line will show the current food price
                            print()
                            food_new_price = int(input("Enter the new price of cosmetics :- ")) # the user will enter the new price for food
                            print()
                            ...
                            food_list_datframe.to_csv(r"C:\Users\sukes\OneDrive\Desktop\assignment\cosmetics_list_csv.csv", encoding='cp1252') #this will save the dataframe to csv
                            ...
                            food_suggestion_dataframe.to_csv(r"C:\Users\sukes\OneDrive\Desktop\assignment\cosmetics_suggestion.csv", encoding='cp1252') # this line will save the suggestion datafgrame to the csv file.
                            ...
                            food_list_datframe.to_csv(r"C:\Users\sukes\OneDrive\Desktop\assignment\cosmetics_list_csv.csv", encoding='cp1252')
                            loop_price_change = 2
                        else:
                            print("The cosmetics is not in cosmetics list")
                            loop_price_change = 2
                ...
                if task_of_owner == 2:
                    ...
                    while loop_add_food == 1:
                        food_to_add = input("enter the name of the cosmetics to be added :- ") # enter the nameo f the food to be added
                        print()
                        if food_to_add in food_list: # this will check weather food to add is present in food list 
                            print("cosmetics is already present in the menu")
                            print()
                        else:
                            price_of_add_food = int(input("Enter the price for cosmetics :-")) # enter the price of the new food
                            print()
                            add_to_food_list = input("press y if you want to add cosmetics to the menu :- ")
                            print()
                            if add_to_food_list == "y":
                                print("Enter the suggestion for the cosmetics")
                                print()
                                suggestion_1 = input("Enter the first suggestion cosmetics :- ") # enter the first suggestion 
                                print()
                                if suggestion_1 in food_list:  # this will check weather food to add is present in food list 
                                    print()
                                    suggestion_2 = input("Enter the second suggestion cosmetics :- ") # enter the second suggestion 
                                    print()
                                    if suggestion_2 in food_list:  # this will check weather food to add is present in food list 
                                        print()
                                        suggestion_3 = input("Enter the third suggestion cosmetics :- ") # enter the third suggestion 
                                        print()
                                        if suggestion_3 in food_list:  # this will check weather food to add is present in food list 
                                            ...
                                            food_suggestion_dataframe.to_csv(r"C:\Users\sukes\OneDrive\Desktop\assignment\cosmetics_suggestion.csv", encoding='cp1252')
                                            food_list_datframe = pd.DataFrame(food_list, index= [0])
                                            food_list_datframe = food_list_datframe.T 
                                            food_list_datframe.to_csv(r"C:\Users\sukes\OneDrive\Desktop\assignment\cosmetics_list_csv.csv", encoding='cp1252')
                                            loop_add_food = 2
                                        else:
                                            print("Please enter the suggested cosmetics to the list first")
                                            print()
                                    else:
                                        print("Please enter the suggested cosmetics to the list first")
                                        print()
                ...
                if task_of_owner == 3:
                    ...
                    if loop_delete_food == 1:
                        print(food_list)
                        food_to_delete = input("Enter the name of the cosmetics you want to delete :- ") # enter the name of the food you want to delete
                        if food_to_delete in food_list:
                            sure_to_delete = input("Enter y if you want to delete cosmetics :- ")
                            if sure_to_delete == 'y':
                                print("The cosmetics is deleted")
                            ...
                            print("The cosmetics is already not in food list")
